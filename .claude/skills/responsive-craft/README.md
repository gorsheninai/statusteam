...
├── scripts/
│   ├── preview.cjs                       # Serves preview.html over HTTP, opens browser
│   ├── preview.html                     # Multi-viewport iframe UI (dark theme, toolbar, scale toggle)
│   ├── snapshot.cjs                      # Headless screenshots at every breakpoint
│   └── serve-static.cjs                  # Zero-dependency static server with live reload
├── references/
