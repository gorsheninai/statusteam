...
```bash
node .claude/skills/responsive-craft/scripts/preview.cjs http://localhost:3000
node .claude/skills/responsive-craft/scripts/preview.cjs ./index.html
node .claude/skills/responsive-craft/scripts/preview.cjs http://localhost:3000 --breakpoints 375,768,1024,1440,1920
```
...
node .claude/skills/responsive-craft/scripts/snapshot.cjs http://localhost:3000

# Capture baseline, make changes, then capture again for comparison
node .claude/skills/responsive-craft/scripts/snapshot.cjs http://localhost:3000 --before
