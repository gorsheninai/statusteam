...
```bash
node .claude/skills/responsive-craft/scripts/preview.cjs <url-or-path>
```
...
Custom breakpoints:
```bash
node .claude/skills/responsive-craft/scripts/preview.cjs <url> --breakpoints 320,768,1024,1440,1920
```
