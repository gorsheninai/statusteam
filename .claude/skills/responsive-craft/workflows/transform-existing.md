...
**Snapshot comparison (optional):** For before/after documentation, use `node .claude/skills/responsive-craft/scripts/snapshot.cjs <url> --before` before fixing, then `node .claude/skills/responsive-craft/scripts/snapshot.cjs <url>` after fixing to generate a visual comparison.
...
If they accept, run `node .claude/skills/responsive-craft/scripts/preview.cjs <url>`.
