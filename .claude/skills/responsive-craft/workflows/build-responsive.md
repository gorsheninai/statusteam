...
- `node .claude/skills/responsive-craft/scripts/preview.cjs <url>` — opens all breakpoints side by side in the browser
- `node .claude/skills/responsive-craft/scripts/snapshot.cjs <url>` — captures screenshots at each breakpoint
